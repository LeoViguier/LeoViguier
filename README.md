...
- [**`UberEats`**](https://github.com/LeoViguier/UberEats), Is a private project meant to mass create Uber Eats accounts, in order to stack up on promotions. ![Python](https://img.shields.io/badge/-Python-000?&logo=Python)
- [**`annoyme`**](https://github.com/LeoViguier/annoyme), Is a program meant to remotely annoy you. It spins up a web server that listen for various actions to execute on your computer like playing sounds, moving windows, display text and more ![Python](https://img.shields.io/badge/-Python-000?&logo=Python) ![HTML](https://img.shields.io/badge/-HTML-000?&logo=html5) ![CSS](https://img.shields.io/badge/-CSS-000?&logo=css3) ![Flask](https://img.shields.io/badge/-Flask-000?&logo=flask) 
...
- **`HumanTyper`** is a project meant to simulate human typing, down to human-made typing errors relative to the keyboard layout and my keyboard's input bugs. It is trained on data I've created myself, and is meant to be used for web automation in order to fool the anti-bot measures of websites, which I believe will get more and more sophisticated in the future. ![Python](https://img.shields.io/badge/-Python-000?&logo=Python) 
